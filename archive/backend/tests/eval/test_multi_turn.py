"""Multi-turn coherence evals — LLM-as-judge.

Tests whether conversation continues naturally across turns:
corrections, clarifications, topic switches, context awareness.
"""
...
SCENARIOS = load_scenarios("multi_turn.json")
