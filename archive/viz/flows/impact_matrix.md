...
| `brain_dump_extract.md` | prompt | brain_dump (step: extract) | entities, item_events, items, memories |  |
| `brain_dump_respond.md` | prompt | brain_dump (step: respond) | entities, item_events, items, memories |  |
| `conversation_extract.md` | prompt | conversation (step: extract_implicit) | item_events, items |  |
| `conversation_respond.md` | prompt | conversation (step: respond) | item_events, items |  |
| `emotional_detect.md` | prompt | emotional (step: detect_level) |  |  |
| `emotional_respond.md` | prompt | emotional (step: respond) |  |  |
...
| `status_done_respond.md` | prompt | status_done (step: respond) | item_events, items |  |
...
| `pipelines/brain_dump.yaml` | pipeline | brain_dump pipeline | entities, item_events, items, memories |  |
| `pipelines/conversation.yaml` | pipeline | conversation pipeline | item_events, items |  |
| `pipelines/emotional.yaml` | pipeline | emotional pipeline |  |  |
...
| `pipelines/status_done.yaml` | pipeline | status_done pipeline | item_events, items |  |