"""Emotional intelligence evals — LLM-as-judge.

Tests whether responses handle emotional states with appropriate warmth,
brevity, and without toxic positivity or unsolicited advice.
"""
...
SCENARIOS = load_scenarios("emotional.json")
...
async def test_emotional_intelligence(
    ...
    result = await run_eval_scenario(
        ...
        seed_messages=scenario.get("seed_messages"),
